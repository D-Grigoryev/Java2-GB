...
//    (в том числе Scanner), тестировать просто из метода main() прописывая add() и get().
    public static void main(String[] args) {
      ...
      Words words= new Words(new String []
            {"привет", "трактор", "контейнер", "контейнер", "привет", "яблоко", "золото", "сон", "контейнер", "солнце", "танк"});
        words.getWords();
        PhoneBook phoneBook = new PhoneBook();

        phoneBook.add("Иванов", 23123123);
        phoneBook.add("Иванов", 56787687);
        phoneBook.add("Иванов", 83213311);
        phoneBook.add("Сидоров", 76546456);
